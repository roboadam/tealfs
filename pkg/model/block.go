...
func (d *DiskPointer) BlockId() BlockId { return d.blockId }

func NewDiskPointer(nodeId NodeId, disk DiskId, fileName BlockId) DiskPointer {
	return DiskPointer{
		nodeId:  nodeId,
		disk:    disk,
		blockId: fileName,
...
func (d *DiskPointer) ToBytes() []byte {
	...
	fileName := StringToBytes(string(d.blockId))
