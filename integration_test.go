...
func TestOneNodeCluster(t *testing.T) {
	...
	go startTealFs(configPath, webdavAddress, uiAddress, nodeAddress, 1, time.Hour, ctx)
...
func TestTwoNodeCluster(t *testing.T) {
	...
	go startTealFs(configPath1, webdavAddress1, uiAddress1, nodeAddress1, 1, time.Hour, ctx1)
	go startTealFs(configPath2, webdavAddress2, uiAddress2, nodeAddress2, 1, time.Hour, ctx2)
...
func TestTwoNodeOneStorageCluster(t *testing.T) {
	...
	go startTealFs(configPath1, webdavAddress1, uiAddress1, nodeAddress1, 0, time.Hour, ctx)
	go startTealFs(configPath2, webdavAddress2, uiAddress2, nodeAddress2, 1, time.Hour, ctx)
	time.Sleep(time.Second)
...
func TestTwoNodeClusterLotsOfFiles(t *testing.T) {
	...
	go startTealFs(configPath1, webdavAddress1, uiAddress1, nodeAddress1, 1, time.Hour, ctx)
